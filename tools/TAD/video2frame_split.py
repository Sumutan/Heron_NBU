...
def dump_frames(vid_item):
    ...
    for i in range(videolen_true):
        ...
        if img is not None:
            cv2.imwrite('{}/{:d}.jpg'.format(out_full_path, i + 1), img)
        else:
...
def parse_args():
    ...
    parser.add_argument('--src_dir', default="/home/ma-user/work/dataset/TAD/depth", type=str)
    parser.add_argument('--out_dir', default="/home/ma-user/work/dataset/TAD/DepthFrames", type=str)
