...
def is_abnormal(video_pth):  # 绝对路径
    pkl_save_pth = 'gt-violence-dic.pickle' #'/home/ma-user/work/dataset/XD_violence/XD_violence_test_pickle/'
...
# 打开.pickle文件
with open('gt-violence-dic.pickle', 'rb') as file:
    # 使用pickle.load()方法加载对象
    loaded_object = pickle.load(file)
    pass

#  test_pkl_path='/home/ma-user/work/dataset/NB_tech/NBUabnormal_snippets'
# with open('/home/ma-user/work/dataset/NB_tech/NBUabnormal_snippets/robbery_7-2.pickle', 'rb') as file:
#     # 使用pickle.load()方法加载对象
